                        ...
                        <div className="col-lg-12">
                            <div className="bs-component">
                                <FormGroup label="Nome :*" htmlFor="inputNome"> 
                                    <input type="text" className="form-control" id="inputNome" name="nome" value={this.state.nome}
                                    onChange={(e) => {this.setState({nome:e.target.value})}} />
                                </FormGroup>
                                <FormGroup label="Email :*" htmlF="inputEmail">
                                    <input type="text" className="form-control" id="inputEmail" name="email" value={this.state.email}
                                ...
                                <FormGroup label="Repita a Senha :*" htmlFor="inputRepitaSenha">
                                    <input type="password" className="form-control" id="inputRepitaSenha" name="repitaSenha" 
